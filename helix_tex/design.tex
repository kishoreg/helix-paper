...
constraints are configured in \helix. \seas uses state machines to
configure different resources differently based on workflow. They also have an
...
\helix's decisions.  They may have application-specific requirements that
cannot be expressed natively in \helix.  For example, HBase can use \emph{semi-auto}
